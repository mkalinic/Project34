...
namespace AutofacIdentityExample.Controllers
{
    [Authorize]
    public class Account1Controller : Controller
    {
        ...
        public Account1Controller(ApplicationUserManager userManager)
        {
            _userManager = userManager;
            _authManager = System.Web.HttpContext.Current.GetOwinContext().Authentication;
            _signInManager = new ApplicationSignInManager(userManager, _authManager);
        }
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<string> Login(CredentialsModel data)
        {
            ...
            var current = SignInManager.AuthenticationManager.AuthenticationResponseGrant.Identity.Name;

            var test = System.Web.HttpContext.Current.User.Identity.GetUserId();
